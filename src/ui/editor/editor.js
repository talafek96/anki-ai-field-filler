...
(function() {
    ...
    window.aiFiller = {
        ...
        init: function(isExpanded = true) {
            ...
            container.innerHTML = `
                <div class="ai-filler-prompt-header">
                    ...
                    <div class="ai-filler-header-actions">
                        ...
                        <button id="ai-filler-trash-btn" class="ai-filler-nav-btn" title="Clear All Fields">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            document.getElementById('ai-filler-trash-btn').addEventListener('click', () => this.onClearFields());
