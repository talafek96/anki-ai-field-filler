"""Tests for settings export / import (settings_io module + ConfigManager)."""
...
def _make_config_manager(config=None, defaults=None):
    ...
    return ConfigManager(), mock_addon_mgr
...
# ---------------------------------------------------------------------------
# ConfigManager export / import methods
# ---------------------------------------------------------------------------
