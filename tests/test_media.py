...
from src.core.media import Media, _pcm_to_wav


class TestMedia:
    def test_save_audio_mp3(self, mock_mw) -> None:
        mp3_bytes = b"\xff\xfb\x90\x00" + b"\x00" * 100
        result = Media.save_audio(mp3_bytes, "TestField")
    ...
    def test_save_audio_wav(self, mock_mw) -> None:
        ...
        result = Media.save_audio(wav_bytes, "VoiceField")
    ...
    def test_save_audio_raw_pcm_wrapped_as_wav(self, mock_mw) -> None:
        ...
        result = Media.save_audio(pcm_bytes, "GoogleTTS")
    ...
    def test_save_audio_id3_mp3(self, mock_mw) -> None:
        ...
        result = Media.save_audio(id3_bytes, "ID3Field")

        assert result.endswith(".mp3]")

    def test_save_image(self, mock_mw) -> None:
        png_bytes = b"\x89PNG" + b"\x00" * 100
        result = Media.save_image(png_bytes, "ImageField")
    ...
    def test_filename_sanitizes_special_chars(self) -> None:
        filename = Media._generate_filename("Field With Spaces!", "mp3")
    ...
    def test_filenames_are_unique(self) -> None:
        f1 = Media._generate_filename("Same", "png")
        f2 = Media._generate_filename("Same", "png")
