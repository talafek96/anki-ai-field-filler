...
from ai_field_filler.core.field_filler import (
    BatchFiller,
    BatchNoteItem,
    BatchProgress,
    BatchProposedChange,
...
class TestBatchFiller:
    @patch(_HTTP_URLOPEN)
    @patch("ai_field_filler.core.field_filler.mw")
...
class TestPartialFieldFailure:
    ...
    def test_image_failure_keeps_text_fields(
        ...
        with patch("ai_field_filler.core.field_filler.create_image_provider") as mock_img_factory:
...
class TestRichFieldBatch:
    ...
    def test_rich_field_with_image_provider(
        ...
        with (
            patch("ai_field_filler.core.field_filler.create_image_provider") as mock_img_factory,
    ...
    def test_rich_with_audio_flag(self, mock_mw: MagicMock, mock_urlopen: MagicMock) -> None:
        ...
        with (
            patch("ai_field_filler.core.field_filler.create_tts_provider") as mock_tts_factory,
            patch("ai_field_filler.core.field_filler.MediaHandler.save_audio") as mock_save,
        ):
