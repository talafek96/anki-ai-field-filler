...
from ai_field_filler.core.field_filler import FieldFiller
...
class TestRenderFlags:
    ...
    def test_image_flag_replaced(self) -> None:
        ...
        with patch("ai_field_filler.core.field_filler.create_image_provider") as mock_factory:
            mock_prov = MagicMock()
            mock_prov.generate_image.return_value = b"\x89PNG_fake"
            mock_factory.return_value = mock_prov

            with patch("ai_field_filler.core.field_filler.MediaHandler.save_image") as mock_save:
    ...
    def test_audio_flag_replaced(self) -> None:
        ...
        with patch("ai_field_filler.core.field_filler.create_tts_provider") as mock_factory:
            mock_prov = MagicMock()
            mock_prov.synthesize.return_value = b"\xff\xfb\x90\x00" + b"\x00" * 50
            mock_factory.return_value = mock_prov

            with patch("ai_field_filler.core.field_filler.MediaHandler.save_audio") as mock_save:
    ...
    def test_mixed_flags(self) -> None:
        ...
        with (
            patch("ai_field_filler.core.field_filler.create_image_provider") as mock_img_f,
            patch("ai_field_filler.core.field_filler.create_tts_provider") as mock_tts_f,
            patch("ai_field_filler.core.field_filler.MediaHandler.save_image") as mock_save_img,
            patch("ai_field_filler.core.field_filler.MediaHandler.save_audio") as mock_save_aud,
        ):
    ...
    def test_multiple_image_flags_indexed(self) -> None:
        ...
        with patch("ai_field_filler.core.field_filler.create_image_provider") as mock_factory:
            ...
            with patch(
                "ai_field_filler.core.field_filler.MediaHandler.save_image",
    ...
    @patch("ai_field_filler.core.field_filler.time.sleep")
...
class TestRenderRichContent:
    ...
    def test_flags_with_legacy_image_prompt(self) -> None:
        ...
        with (
            patch("ai_field_filler.core.field_filler.create_image_provider") as mock_factory,
            patch("ai_field_filler.core.field_filler.MediaHandler.save_image") as mock_save,
        ):
            mock_prov = MagicMock()
...
class TestGenerateAndParse:
    ...
    @patch("ai_field_filler.core.field_filler.create_text_provider")
